...
export default function SettingsPage() {
  ...
  const save = async () => {
    ...
    setSaving(true);
    setStatus('idle');
    const { error } = await (supabase.from('business_info') as any)
      .update({
  ...
  const inputClass =
    'w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-gray-500 focus:border-purple-500/50 focus:outline-none';
        ...
        <div className="grid grid-cols-1 gap-5 lg:grid-cols-2">
          ...
          <div>
            ...
            <input
              ...
              className={inputClass}
              placeholder="info@ekviralights.com"
            />
          </div>
          <div>
            <label className="mb-2 block text-sm font-semibold text-gray-300">
